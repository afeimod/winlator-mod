...
public abstract class RootFSInstaller {
    public static final byte LATEST_VERSION = 16; // TODO increment it on wine or rootfs update
    public static final byte UPDATE_WINEPREFIX_VERSION = 5; // set it if main wine version change
